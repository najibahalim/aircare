...
export class MyApp {
  ...
  constructor(platform: Platform, statusBar: StatusBar, splashScreen: SplashScreen, public menuCtrl: MenuController, public push: Push, public alertCtrl: AlertController) {
    platform.ready().then(() => {
        ...
        let confirmAlert = this.alertCtrl.create({
          ...
          buttons: [{
            ...
            handler: () => {
              ...
              this.nav.push(TabPage, { message: data.message });
            }
          }]
        });
